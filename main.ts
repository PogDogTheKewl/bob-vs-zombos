namespace SpriteKind {
    ...
    export const zombo1 = SpriteKind.create()
    export const zombo2 = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.zombo2, SpriteKind.Player, function (sprite, otherSprite) {
    mySprite.destroy(effects.spray, 500)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.zombo1, function (sprite, otherSprite) {
    mySprite7.destroy(effects.ashes, 500)
    mySprite7.destroy(effects.ashes, 500)
})
sprites.onOverlap(SpriteKind.zombo1, SpriteKind.zombo2, function (sprite, otherSprite) {
    mySprite8.destroy(effects.disintegrate, 500)
    mySprite7.destroy(effects.disintegrate, 500)
})
...
sprites.onOverlap(SpriteKind.zombo1, SpriteKind.zombo1, function (sprite, otherSprite) {
    mySprite7.destroy(effects.disintegrate, 500)
    mySprite7.destroy(effects.disintegrate, 500)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.zombo2, function (sprite, otherSprite) {
    mySprite8.destroy(effects.ashes, 500)
    mySprite8.destroy(effects.ashes, 500)
})
sprites.onOverlap(SpriteKind.zombo2, SpriteKind.zombo2, function (sprite, otherSprite) {
    mySprite8.destroy(effects.disintegrate, 500)
    mySprite8.destroy(effects.disintegrate, 500)
})
sprites.onOverlap(SpriteKind.zombo1, SpriteKind.Player, function (sprite, otherSprite) {
    mySprite.destroy(effects.spray, 500)
})
...
mySprite = sprites.create(assets.image`Bob`, SpriteKind.Player)
mySprite.setStayInScreen(true)
mySprite.setPosition(37, 56)
...
for (let index = 0; index < 11; index++) {
    ...
    music.setVolume(49)
    music.playMelody("C5 B G E F A C E ", 500)
    music.playMelody("C5 A D A G A B E ", 500)
    music.playMelody("C5 C G C F C A C ", 500)
    music.playMelody("B A A D A A B A ", 552)
