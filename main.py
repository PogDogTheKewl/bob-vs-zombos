...
for index in range(11):
    ...
    mySprite5 = sprites.create(img("""
            . . . . . . . . . . . . . . . . 
                    ...
                    . . . 2 4 4 5 1 1 5 5 4 2 . . . 
                    . . . 2 5 5 1 1 1 5 4 5 2 . . . 
                    . . 2 4 4 5 4 2 2 2 2 2 2 . . . 
                    . . . 2 2 2 2 2 . . . . . . . . 
                    . . . . . . . . . . . . . . . .
        """),
        SpriteKind.enemy)
    mySprite5.set_position(107, 85)
    ...
    animation.run_image_animation(mySprite6,
        ...
        True)
    music.set_volume(49)
    music.play_melody("C5 B G E F A C E ", 500)
    music.play_melody("C5 A D A G A B E ", 500)
    music.play_melody("C5 C G C F C A C ", 500)
    music.play_melody("B A A D A A B A ", 552)
